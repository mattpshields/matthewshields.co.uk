      ...
      - title: Poker Probability Engine
        ...
        footer_list:
          ...
          - value: ' Double the number of iterations in more than 5x the speed'
            label: 'Improvement:'
      - title: Football Transfer Window Social Analysis Tool
        footer_list:
          - label: 'Front-end:'
            value: React
          - label: 'Back-end:'
        ...
        text: >-
          In order to comment on who are the 'hot picks' for the Premier League
          transfer window, I built a tool that would track Twitter mentions and
          rank players in real time. This required a lot of back-end analysis
          and performance optimisation, and was hugely successful.
  - type: block_list
